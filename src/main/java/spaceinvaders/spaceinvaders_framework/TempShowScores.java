 ...
 * normally this table would be able to view from the main menu. but as off writting this
 * the main menu hasn't been implemented yet. So instead you can look up the table through this seperate class.
 * Once the main menu has been implemented methods from this class will be implemented in the game class 
 * so you can view the highscores
 * in the game itself.
 * 
...
public class TempShowScores {
    ...
    private void gui() {
        ...
        Object[][] data = {
                {"1. ", Score1.getName(), Score1.getScore()},
        ...
        //method that makes sure that when we press quit the application will end.
