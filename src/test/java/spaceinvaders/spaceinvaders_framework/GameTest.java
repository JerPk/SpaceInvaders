...
//	// * whether or not the spritesheet was successfully loaded from the png
//	// file.
//	// */
//	// @Test
...
//	// final BufferedImage testSprite =
//	// loader.LoadImage("res/sprite_sheet.png");
...
//
//	/**
//	 * The JUnite test of the KeyPressed method. This particular method tests if
//	 * Left key is pressed.
//	 */
//	@Test
...
//
//		final KeyEvent key = new KeyEvent(screen, 0, System.currentTimeMillis(), 0, KeyEvent.VK_LEFT,
...
//
//		final KeyEvent key = new KeyEvent(screen, 0, System.currentTimeMillis(), 0, KeyEvent.VK_RIGHT,
//				KeyEvent.CHAR_UNDEFINED);
//
//		screen.keyPressed(key);
//
...
//
//		final KeyEvent key = new KeyEvent(screen, 0, System.currentTimeMillis(), 0, KeyEvent.VK_SPACE,
//				KeyEvent.CHAR_UNDEFINED);
//
//		screen.keyPressed(key);
//
...
//
//	/**
//	 * The JUnite test of the KeyReleased method. This particular method tests
//	 * if Left is released.
//	 */
//	@Test
