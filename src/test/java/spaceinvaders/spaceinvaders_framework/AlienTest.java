...
public class AlienTest {
  ...
  /**
   * The JUnit test of a HMovement where the Alien has reached the rigameht hand
   * Border.
   */
  @Test
  ...
  /**
   * The JUnit test of a HMovement where the BossAlien has reached the left hand
   * Border.
   */
  @Test
  ...
  /**
   * The JUnit test of VMovement where the BossAlien has not reached the bottom
   * of the screen.
   */
  @Test
